...
class DistinguishingMarksV2ResourceIntTest : IntegrationTestBase() {

  @DisplayName("GET v2/person/{personId}/person/$PRISONER_NUMBER/distinguishing-marks")
  @Nested
  inner class GetDistinguishingMarks {
    ...
    inner class Security {
      ...
      fun `access forbidden when no authority`() {
        webTestClient.get().uri("/v2/person/$PRISONER_NUMBER/distinguishing-marks")
          .exchange()
    ...
    inner class NotFound {
      ...
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.get()
          .uri("/v2/person/$PRISONER_NUMBER_NOT_FOUND/distinguishing-marks")
  ...
  @DisplayName("GET v2/person/{personId}/distinguishing-mark/{markId}")
  @Nested
  inner class GetDistinguishingMarkById {
    ...
    inner class Security {
      @Test
      fun `access forbidden when no authority`() {
        webTestClient.get().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/$MARK_ID")
          .exchange()
          .expectStatus().isUnauthorized
      }
    ...
    inner class NotFound {
      ...
      @Test
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.get().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/$MARK_ID_NOT_FOUND")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_WRITE_ROLE)))
          .exchange()
          .expectStatus().isNotFound
          .expectBody().json(PRISON_API_NOT_FOUND_RESPONSE.trimIndent())
  ...
  @DisplayName("PUT v2/person/$PRISONER_NUMBER/distinguishing-mark/{markId}")
  @Nested
  inner class UpdateDistinguishingMark {
    ...
    inner class Security {
      @Test
      fun `access forbidden when no authority`() {
        webTestClient.put().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/$MARK_ID")
    ...
    inner class NotFound {
      ...
      @Test
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.put().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/$MARK_ID_NOT_FOUND")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_WRITE_ROLE)))
          .bodyValue(DISTINGUISHING_MARK_REQUEST)
          .exchange()
          .expectStatus().isNotFound
  ...
  @DisplayName("POST v2/person/$PRISONER_NUMBER/distinguishing-mark/{prisonerNumber}")
  @Nested
  inner class CreateDistinguishingMark {
    ...
    inner class Security {
      @Test
      fun `access forbidden when no authority`() {
        webTestClient.post().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark")
    ...
    inner class NotFound {
      ...
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.post()
          .uri("/v2/person/$PRISONER_NUMBER_NOT_FOUND/distinguishing-mark")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_WRITE_ROLE)))
          .contentType(MULTIPART_FORM_DATA)
          .body(BodyInserters.fromMultipartData(imageAndMarkDetailsRequestBody(MULTIPART_FILE).build()))
          .exchange()
    ...
    inner class VirusScan {
      ...
      fun `handles a failed virus scan result`() {
        webTestClient.post()
          .uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_WRITE_ROLE)))
          .contentType(MULTIPART_FORM_DATA)
  ...
  @DisplayName("GET v2/person/$PRISONER_NUMBER/distinguishing-mark/image/{imageId}")
  @Nested
  inner class GetDistinguishingMarkImage {
    ...
    inner class NotFound {
      ...
      @Test
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.get().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/image/$IMAGE_ID_NOT_FOUND")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_ROLE)))
          .exchange()
          .expectStatus().isNotFound
          .expectBody().json(PRISON_API_NOT_FOUND_RESPONSE.trimIndent())
  ...
  @DisplayName("PUT v2/person/$PRISONER_NUMBER/distinguishing-mark/image/{imageId}")
  @Nested
  inner class UpdateDistinguishingMarkImage {
    ...
    inner class Security {
      @Test
      fun `access forbidden when no authority`() {
        webTestClient.put().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/image/$IMAGE_ID")
          .contentType(MULTIPART_FORM_DATA)
    ...
    inner class NotFound {
      ...
      @Test
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.put().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/image/$IMAGE_ID_NOT_FOUND")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_WRITE_ROLE)))
          .contentType(MULTIPART_FORM_DATA)
          .body(BodyInserters.fromMultipartData(imageRequestBody(MULTIPART_FILE).build()))
          .exchange()
  ...
  @DisplayName("POST v2/person/$PRISONER_NUMBER/distinguishing-mark/{markId}/image")
  @Nested
  inner class AddDistinguishingMarkImage {
    ...
    inner class Security {
      @Test
      fun `access forbidden when no authority`() {
        webTestClient.post().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/$MARK_ID/image")
          .contentType(MULTIPART_FORM_DATA)
          .body(BodyInserters.fromMultipartData(imageRequestBody(MULTIPART_FILE).build()))
          .exchange()
          .expectStatus().isUnauthorized
    ...
    inner class NotFound {
      ...
      @Test
      fun `handles a 404 not found response from downstream api`() {
        webTestClient.post().uri("/v2/person/$PRISONER_NUMBER/distinguishing-mark/$MARK_ID_NOT_FOUND/image")
          .headers(setAuthorisation(roles = listOf(CorePersonRecordRoleConstants.CORE_PERSON_RECORD_READ_WRITE_ROLE)))
          .contentType(MULTIPART_FORM_DATA)
          .body(BodyInserters.fromMultipartData(imageRequestBody(MULTIPART_FILE).build()))
          .exchange()
