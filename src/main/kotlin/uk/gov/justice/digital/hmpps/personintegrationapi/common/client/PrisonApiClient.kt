...
interface PrisonApiClient {
  ...
  fun updateDistinguishingMark(
    @RequestBody request: DistinguishingMarkRequest,
    @PathVariable prisonerNumber: String,
    @PathVariable markId: Int,
  ): ResponseEntity<DistinguishingMarkDto>

  @PostExchange("/person/{prisonerNumber}/distinguishing-mark", accept = [MULTIPART_FORM_DATA_VALUE])
  fun createDistinguishingMark(
    @RequestPart(name = "file") file: MultipartFile?,
    @RequestPart request: DistinguishingMarkRequest,
    @PathVariable prisonerNumber: String,
  ): ResponseEntity<DistinguishingMarkDto>
