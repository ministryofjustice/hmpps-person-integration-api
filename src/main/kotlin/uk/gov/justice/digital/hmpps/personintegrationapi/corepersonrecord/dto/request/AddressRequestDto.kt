...
data class AddressRequestDto(
  @Schema(
    description = "ID of the pseudonym/alias for a person this address is associated with. This field is required while NOMIS is still in use.",
    example = "true",
  ...
  @Schema(description = "Boolean indicating if the person has no fixed abode.", example = "False")
  val noFixedAbode: Boolean? = null,

  @Schema(description = "Building name", example = "1")
  @field:Size(max = 30)
  val buildingNumber: String? = null,

  @Schema(description = "Building name", example = "The Building")
  @field:Size(max = 135)
  val buildingName: String? = null,

  @Schema(description = "Thoroughfare name", example = "The Road")
  @field:Size(max = 160)
  ...
  @Schema(description = "Postcode", example = "A123BC")
  @field:Size(max = 8)
